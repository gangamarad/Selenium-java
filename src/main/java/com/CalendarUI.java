...
public class CalendarUI {
	public static void main(String[] args) {
		...
		driver.findElements(By.cssSelector(".react-calendar__year-view__months__month")).get(0).click();
		...
		for(int i =0; i<list.size();i++)
		{
			...
			Assert.assertEquals(list.get(i).getAttribute("value"),expectedArray[i]);
